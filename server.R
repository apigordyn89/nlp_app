...
server<-function(input, output, session) {
  ...
  observeEvent(input$introButton, {
    updateTabsetPanel(session,'displayedTab',selected = 'examplesPanel')})
  ...
  observe({if(input$displayedTab == 'mainPanel'| input$displayedTab == 'reviewsPanel'|input$displayedTab == 'examplesPanel'| input$displayedTab == 'introPanel'){
